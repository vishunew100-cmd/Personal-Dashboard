...
from app.utils.plot_utils import balance_by_creditor, account_type_pie
...
# Render KPIs and charts (use st.columns and st.plotly_chart)
...
if plots.get("balance"): st.plotly_chart(plots["balance"], use_container_width=True)
if plots.get("types"): st.plotly_chart(plots["types"], use_container_width=True)
